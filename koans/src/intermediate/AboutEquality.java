...
public class AboutEquality {
    ...
    static class Car {
        ...
        public boolean equals(Object other) {
            if (other == null || other.getClass() != Car.class)
                return false;
            ...
            if (otherCar.name == null || otherCar.name.isEmpty())
                return false;
            if (this.name.equals(((Car)other).name) && this.horsepower == ((Car)other).horsepower)
                return true;
            return false;
        }
        ...
        public int hashCode() {
            ...
            //Would need to return something that is the same that we've checked is the same
            // We tested that the name and horse power are the same, so use that
