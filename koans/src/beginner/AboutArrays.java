...
public class AboutArrays {
    ...
    public void anArraysHashCodeMethodDoesNotConsiderElements() {
        ...
        //            method returns a random integer that is unique for each instance.
        //            This integer might change between several executions of the application
